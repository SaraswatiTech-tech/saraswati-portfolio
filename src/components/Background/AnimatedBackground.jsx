...
export default function AnimatedBackground() {
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden bg-[#020617]">
      ...
      <div
        ref={glow1}
        className="absolute top-[15%] left-[10%] w-[600px] h-[600px] rounded-full opacity-[0.18] blur-[130px] pointer-events-none"
        style={{ background: 'radial-gradient(circle, #3b82f6 0%, transparent 65%)' }}
      />
      <div
        ref={glow2}
        className="absolute bottom-[10%] right-[5%] w-[500px] h-[500px] rounded-full opacity-[0.14] blur-[110px] pointer-events-none"
        style={{ background: 'radial-gradient(circle, #7c3aed 0%, transparent 65%)' }}
      />
      <div
        className="absolute top-[40%] right-[30%] w-[350px] h-[350px] rounded-full opacity-[0.08] blur-[90px] pointer-events-none"
...
export function ScrollIndicator() {
  return (
    ...
    >
      ...
      <span className="text-[11px] text-slate-500 tracking-widest uppercase">Scroll Down</span>
      <motion.div
        animate={{ y: [0, 4, 0] }}
        transition={{ duration: 1.8, repeat: Infinity, ease: 'easeInOut', delay: 0.15 }}
      >
        <svg width="14" height="14" viewBox="0 0 16 16" className="text-slate-500">
